...
namespace NerdStore.Vendas.Domain
{
    ...
    {
        public Voucher(string codigo, decimal? valorDesconto, decimal? percentualDesconto,
            int quantidade, DateTime dataValidade, bool ativo, bool utilizado, TipoDescontoVoucher tipoDescontoVoucher)
        {
            Codigo = codigo;
    ...
    public class VoucherAplicavelValidation : AbstractValidator<Voucher>
    {
        ...
        public static string PercentualDescontoErroMsg => "O valor do percentual de desconto precisa ser superior a 0.";
